...
export const metadata: Metadata = {
  title: "Mentions légales — Donia",
  description:
    "Mentions légales du service Donia opéré par NOVEKAI LTD. Éditeur, hébergement, prestataires, propriété intellectuelle.",
};
...
export default function MentionsLegalesPage() {
  return (
    <LegalLayout category="Information éditeur" title="Mentions légales">
      ...
      <p>
        Le service Donia est édité et exploité par la société <strong>NOVEKAI LTD</strong>, société à
      ...
      <p>Le directeur de la publication du site et du service Donia est :</p>
      <ul>
        <li>
      ...
      <p>
        Le projet Donia a été co-imaginé par M.&nbsp;Gilles-Christ Espoir Selomey AGBESSI (CEO) et
        M.&nbsp;Paul ASSOGBA-ECOGBO (COO), au sein de NOVEKAI LTD.
      </p>

      <h2>3. Hébergement</h2>
      <p>Le site web Donia est hébergé par :</p>
      <ul>
        <li>
      ...
      <p>
        L&rsquo;ensemble des contenus présents sur les supports Donia (site web, application mobile,
      ...
      <p>
        La marque <strong>Donia</strong>, le logo Donia et tous les signes distinctifs associés sont des
      ...
      <p>
        Le site Donia peut contenir des liens vers d&rsquo;autres sites internet édités par des tiers.
      ...
      <p>
        La création de liens hypertextes en direction du site Donia est autorisée, sous réserve
        d&rsquo;un usage loyal et non commercial. L&rsquo;utilisation de la marque Donia dans le cadre
      ...
      <h2>8. Contact</h2>
      <p>
        Pour toute question relative aux présentes mentions légales ou au service Donia, vous pouvez nous
        joindre :
      </p>
      <ul>
        <li>
